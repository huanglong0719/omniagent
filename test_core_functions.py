...
async def test_encryption_functionality():
    ...
    session = Session(session_id="test_session_encryption", user_id="test_user")
...
async def test_memory_management():
    ...
    # Create test session
    session = Session(session_id="test_session_memory", user_id="test_user")
...
async def run_core_functions_test():
    """Run core functions test."""
    print("Starting Core Functions Test...")
    ...
    if passed == total:
        print("✓ All core tests passed! System is ready for production.")
    else:
...
if __name__ == "__main__":
    asyncio.run(run_core_functions_test())
